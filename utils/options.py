...
def get_args():
    ...
    parser.add_argument("--pretrain_choice", default='ViT-B/16') #'ViT-L/14')#'ViT-B/16') # whether use pretrained model
    ...
    parser.add_argument("--img_size", type=tuple, default=(256,256))  #(384,128)) #
